...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $package_manager_ready = $this->moduleHandler->moduleExists('package_manager') && class_exists('\Drupal\package_manager\Event\CollectIgnoredPathsEvent');
    $form['allow_ui_install'] = [
      ...
      '#disabled' => !$package_manager_ready,
    ];

    if (!$package_manager_ready) {
      $form['allow_ui_install_compatiblity'] = [
        '#type' => 'container',
        '#markup' => $this->t('This feature requires Package Manager (a module provided as part of the Automatic Updates module), version 2.5 or newer.'),
      ];
    }
